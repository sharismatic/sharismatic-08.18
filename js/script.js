...
//     $('#fademenu').fadeTo( 300, 1 );
// }
// else {
// 	$('#fademenu').fadeTo( 300, 0.0 );
// }
	...
	form.submit( function() {
		...
		$.ajax(
		{
			...
			success: function( data ) {
				console.log( data )
				$('#form').empty().append('<span style= "text-align: center;">Message sent!</span>');
			},
...
if ($(this).scrollTop() > 40) {
    $('#fademenu').css({display: "block"}).animate({opacity: "1"}, 500);
}
else {
	$('#fademenu').css({display: "none"}).animate( {opacity: "0"}, 500);
}
